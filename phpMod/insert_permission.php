...
if($token_time==0){
	...
	$sql ="INSERT INTO `hesprrs_roles`(`name`, `description`, `project_edit`, `strategiest_summary`, `member_manage`, `data_manage`, `view_data`, `review`) 
	VALUES ('".$role_name."','".$role_diecription."', '".$project_edit."', '".$strategiest_summary."', '".$member_manage."', '".$data_manage."', '".$view_data."', '".$review."')";
